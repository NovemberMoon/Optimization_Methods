# Задача №4 — Управление пакетами активов (динамическое программирование)

**Студент:** <Ф.И.О.>  
**Курс:** 3  
**Дисциплина:** Методы оптимизации  
**Вариант:** 2 — полная математическая постановка + программная реализация + определение наилучшего управления и максимального дохода

**Исходные данные:** см. `config.json` (в корне проекта). Оригинальное задание и таблица входных данных — PDF/Excel, приложенные к заданию (Источник: файл задания). :contentReference[oaicite:0]{index=0}
...
(При необходимости я могу добавить UML PNG, но текстовой схемы достаточно для отчёта.)
